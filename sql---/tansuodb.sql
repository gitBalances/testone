...
CREATE TABLE `delivery_tbl`  (
  ...
  `goods_name` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '货名',
  `goods_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '品类',
  `goods_unit` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '单位',
  `gross_weight` double(8, 2) NOT NULL COMMENT '毛重',
  `car_weight` double(9, 2) NOT NULL COMMENT '皮重',
  `net_weight` double(8, 2) NOT NULL COMMENT '净重',
  `driver_name` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '司机名',
  `plate_number` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '车牌号',
  `driver_phone` int(11) NOT NULL COMMENT '电话',
  `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注,用于展示到数据栏',
  `pid` int(20) NOT NULL COMMENT '外键(对应送收地址表)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3689 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1061 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `role_menu` VALUES (208, 1, 22);
INSERT INTO `role_menu` VALUES (209, 10, 22);
INSERT INTO `role_menu` VALUES (210, 1010, 22);
INSERT INTO `role_menu` VALUES (211, 20, 22);
INSERT INTO `role_menu` VALUES (212, 2010, 22);
INSERT INTO `role_menu` VALUES (213, 2020, 22);
INSERT INTO `role_menu` VALUES (768, 1, 20);
INSERT INTO `role_menu` VALUES (769, 40, 20);
INSERT INTO `role_menu` VALUES (770, 4010, 20);
INSERT INTO `role_menu` VALUES (771, 4020, 20);
...
INSERT INTO `role_menu` VALUES (1039, 1, 1);
INSERT INTO `role_menu` VALUES (1040, 10, 1);
INSERT INTO `role_menu` VALUES (1041, 1010, 1);
INSERT INTO `role_menu` VALUES (1042, 1020, 1);
INSERT INTO `role_menu` VALUES (1043, 20, 1);
INSERT INTO `role_menu` VALUES (1044, 2010, 1);
INSERT INTO `role_menu` VALUES (1045, 2020, 1);
INSERT INTO `role_menu` VALUES (1046, 2030, 1);
INSERT INTO `role_menu` VALUES (1047, 2040, 1);
INSERT INTO `role_menu` VALUES (1048, 30, 1);
INSERT INTO `role_menu` VALUES (1049, 3010, 1);
INSERT INTO `role_menu` VALUES (1050, 40, 1);
INSERT INTO `role_menu` VALUES (1051, 4010, 1);
INSERT INTO `role_menu` VALUES (1052, 4020, 1);
INSERT INTO `role_menu` VALUES (1053, 50, 1);
INSERT INTO `role_menu` VALUES (1054, 5010, 1);
INSERT INTO `role_menu` VALUES (1055, 5020, 1);
INSERT INTO `role_menu` VALUES (1056, 5030, 1);
INSERT INTO `role_menu` VALUES (1057, 5040, 1);
INSERT INTO `role_menu` VALUES (1058, 5050, 1);
INSERT INTO `role_menu` VALUES (1059, 5060, 1);
INSERT INTO `role_menu` VALUES (1060, 5070, 1);
...
INSERT INTO `user_role` VALUES (156, 5, 1);
